...
NyThemeData.set(3, { name: "Chance", price: 40 , owner: "banker"});
...
NyThemeData.set(8, { name: "Chance", price: 40 , owner: "banker"});
NyThemeData.set(10, { name: "Bushwick"  , price: 50, owner: "banker"});
NyThemeData.set(11, { name: "Jail", price: 40 , owner: "banker"});
NyThemeData.set(12, { name: "Forest Hills"  , price: 90, owner: "banker"});
NyThemeData.set(13, { name: "Chance", price: 40 , owner: "banker"});
...
NyThemeData.set(21, { name: "Central Park", price: 40 , owner: "banker"});
NyThemeData.set(22, { name: "Hell's Kitchen" , price: 115, owner: "banker"});
NyThemeData.set(23, { name: "Chance", price: 40 , owner: "banker"});
...
NyThemeData.set(39, { name: "Chance", price: 40 , owner: "banker"});
